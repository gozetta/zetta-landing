...
const CallToAction = () => {
  return (
    <Box as="section" id="developers" sx={styles.callToAction}>
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Heading as="h3">
              Build a career with silicon valley startups
            </Heading>
            <Text as="p">
              Want to work with top Silicon Valley startups, building products that will power the future, remotely?
            </Text>
            <Link path="/developers" sx={styles.button}>
              Apply here
            </Link>
          </Box>
