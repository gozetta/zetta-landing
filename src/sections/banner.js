  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">Collaborate with the best tech talent</Heading>
        <Heading as="h4">
          Enjoy working with the Best &amp; Pre-Vetted Senior Developers with Silicon Valley Expertise.
          <br />
          Tap into a pool of amazing tech talent, unconstrained by location.
        </Heading>
...
const styles = {
  banner: {
    ...
    h2: {
      ...
      mx: 'auto',
      mt: '30px',
      mb: ['40px', null, null, '40px'],
    },

    h4: {
      mx: 'auto',
      mt: '30px',
      mb: ['0px', null, null, '65px'],
    }
  },
  logo: {
    display: 'block',
